...
The manage endpoint directs users to a URL where they can view and manage their VA benefits account. From this URL, users can also view applications that have access to their data and adjust these access grants.
