...
Initiate the OpenID Connect authorization by directing Veterans using your application to `https://dev-api.va.gov/oauth2/authorize` with the following query parameters:
