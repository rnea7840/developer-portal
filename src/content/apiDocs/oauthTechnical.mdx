...
Initiate the OpenID Connect authorization by directing your application's users to `https://dev-api.va.gov/oauth2/authorization` with the following query parameters:
...
* `patient/*` - view a user's VA Health records and patient information, see specific read only scopes below.
...
If you have any questions please feel free to reach out to the VA API Platform team at [api@va.gov](mailto:api@va.gov). If you would like to report a bug or make a feature request, please open an issue on our [GitHub page](https://github.com/department-of-veterans-affairs/vets-api-clients/issues/new/choose).
