...
The `aud` query parameter is the resource server an application makes API calls to. Specifying this parameter in the authorization request prevents applications from leaking `access_tokens` to conterfeit resource servers.
