VA’s Health API allows a user/application to make queries that will return Veteran health records stored in a synthetic Veteran health database without interacting with or understanding the inner workings of VA systems.
