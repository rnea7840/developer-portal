 ...
 * `https://sandbox-api.va.gov/services/fhir/v0/argonaut/data-query/`
 * `https://sandbox-api.va.gov/services/fhir/v0/dstu2/`
 * `https://sandbox-api.va.gov/services/fhir/v0/r4/`
 * `https://sandbox-api.va.gov/services/community-care/v0/eligibility`

Accordingly, the FHIR conformance statements can be retrieved from:

 * `https://sandbox-api.va.gov/services/fhir/v0/argonaut/data-query/metadata`
