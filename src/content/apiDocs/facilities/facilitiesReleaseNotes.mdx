### November 16, 2020
On October 30, 2020 we added a new Facilities API endpoint, 'visn', which retrieves all health facilities for a specified Veterans Integrated Service Network (VISN). This endpoint does not support any other search parameters, such as lat/long.
