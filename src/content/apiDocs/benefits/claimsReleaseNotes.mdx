...
- We corrected our validation logic for `homelessness` in our POST "/forms/526" endpoint. `pointOfContact` is a required sub-property of `homelessness` and must always be included. [These changes were made in PR #9947](https://github.com/department-of-veterans-affairs/vets-api/pull/9947).
