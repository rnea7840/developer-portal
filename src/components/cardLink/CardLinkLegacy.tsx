...
import './CardLinkLegacy.scss';

const CardLinkLegacyPropTypes = {
...
type CardLinkLegacyProps = PropTypes.InferProps<typeof CardLinkLegacyPropTypes>;
 ...
 */
const CardLinkLegacy = (props: CardLinkLegacyProps): JSX.Element => (
  <NavHashLink
    to={props.url}
...
CardLinkLegacy.propTypes = CardLinkLegacyPropTypes;
export { CardLinkLegacy };
