  ...
  return (
    <>
      ...
      <p>
        ...
        process for you, us, and your consumers, we require your API to meet certain expectations.
        Our requirements offer your team many benefits, such as streamlined documentation and
