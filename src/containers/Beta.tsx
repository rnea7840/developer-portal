            ...
            <div className="va-api-hero-callout">
              ...
              <div className={classNames('vads-l-row', 'vads-u-justify-content--space-between')}>
                <div className={classNames('vads-l-col--12', 'medium-screen:vads-l-col--6')}>
                  <p>
                    Mobile applications are at the center of how we work, play, and connect with
                    each other. The VA would like your help to create the next mobile applications
                    to help Veterans.
                  </p>
                  <p>
              ...
              <p className="va-api-hero-disclaimer-text">
                <span className="bold-text">Survey Disclaimer: </span>According to the Paperwork
                ...
                number for this information collection is 2900-0770. The time required to complete
                this information collection is estimated to average 5 minutes per response,
                including the time to review instructions, search existing data resources, gather
                ...
                improving this form, please write to: Office of Information and Regulatory Affairs,
                Office of Management and Budget, Attn: VA Desk Officer; 725 17th St. NW, Washington,
                DC 20503 or sent through electronic mail to oira_submission@omb.eop.gov. Please
                refer to “OMB Control No. 2900-0770” in any correspondence.
              </p>
            </div>
          </div>
        </section>
        <div
          className={classNames('vads-l-grid-container', 'form-container', 'vads-u-margin-y--5')}
        >
          <h1 className="underlined-header">
            Tell us about yourself.{' '}
            <small className="small-header-text">(All responses required unless noted.)</small>
          </h1>
          <form
            action={
              env === 'VICPROD'
            ...
            <div className={classNames('vads-l-row', 'vads-u-margin-top--2p5')}>
              <div className={classNames('vads-l-col--12', 'small-screen:vads-l-col--6')}>
                ...
                <div className="form-checkbox">
                  ...
                  />
                  <label htmlFor={`${idMappings[env].cell}-2`}>
              ...
              >
                ...
                <div className="form-checkbox">
                  <input
                    ...
                    value="DS"
                  />
                  <label htmlFor={`${idMappings[env].auth}-2`}>
                    Access VA on-line services with <img alt="DSLogon Icon" src={ds} />
                    DS Logon
                  </label>
                </div>
                <div className="form-checkbox">
                  <input
                    ...
                    value="ID.Me"
                  />
                  <label htmlFor={`${idMappings[env].auth}-1`}>
                    Access VA on-line services with <img alt="DSLogon Icon" src={idme} />
                  </label>
                </div>
                <div className="form-checkbox">
                  <input
                  ...
                  <label htmlFor={`${idMappings[env].auth}-3`}>
                    Access VA on-line services with{' '}
                    <img
                      style={{ backgroundColor: 'rgb(17, 46, 81)' }}
                      alt="DSLogon Icon"
                      src={mhv}
                    />{' '}
                    MyHealtheVet
