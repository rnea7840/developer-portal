  ...
  <div>
    ...
    <CollapsiblePanel panelName="Thoughtful, consistent versioning to reduce the impact of changes.">
      <p>
        ...
        to ensure breaking changes aren’t published without a major version change. We will send you
        notifications before any new features or versions are added.
      </p>
      <p>
    ...
    <CollapsiblePanel panelName="Consistent rate limiting at 60 requests per minute.">
      ...
      <p>
        <strong>NOTE:</strong> some APIs may have different rate limits. If this applies to you, we
        will let you know during the onboarding process.
      </p>
    ...
    <CollapsiblePanel panelName="Testing and production environments with robust uptime SLAs.">
      ...
      <p>
        We closely monitor access to the production environment, which is why we have developed the
        consumer onboarding process and regularly complete consumer audits to ensure Veteran data
    ...
    <CollapsiblePanel panelName="We’re here for you whenever you have questions.">
      ...
      <p>
        We support your need to integrate our APIs into the support plan, and provide, at a minimum,
        the following for each of our APIs:
        <ul>
          <li>Bug reporting</li>
    ...
    <CollapsiblePanel panelName="Robust and secure auditing to protect you and VA data.">
      ...
      <p>
        Future audits may be required when there is a new version of your application, if there are
    ...
    <CollapsiblePanel panelName="Consistent and thorough API documentation.">
      <p>
        ...
        specific to that API, and examples that demonstrate the use of the API. With Lighthouse, no
        additional documentation is needed outside of what is published on the Lighthouse
    ...
    <CollapsiblePanel panelName="Methods of authentication and authorization for all your consumers’ needs.">
      <p>
        ...
        their APIs, like you. We support multiple authentication types for many common integration
        needs, including:
        <ul>
      ...
      <p>
        Through OAuth, Lighthouse ensures that API interactions are secure and seamless. We generate
        and send an OAuth token that securely retrieves, sends, and updates data.{' '}
      </p>
      <p>
      ...
      <p>
        API keys are maintained within Kong. There is no default expiration date. If a key needs to
        be rotated on a recurring basis, Lighthouse can either update the key immediately or update
        it on a rolling basis, where both keys work for a short period of time and the consumer
