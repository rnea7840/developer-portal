  ...
  <div className="request-production-access">
    ...
    <CollapsiblePanel panelName="Basic information">
      <ul className="checklist">
        ...
        <li>
          Information about your app and its use cases, including the value it provides to Veterans
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              An app icon with a transparent background (1024x1024 pixel image, in PNG, JPG, or GIF
              file format)
            </li>
          </ul>
        </li>
        <li>
          For internal-only APIs, the VASI system name of the application which will consume the API
        </li>
      </ul>
    ...
    <CollapsiblePanel panelName="Privacy policy and terms of service (OAuth APIs only)">
      ...
      <p>
        ...
        <strong>Veteran Confirmation API</strong>, we will review your terms of service and privacy
        policies to make sure they meet our quality, plain language, and content standards. We may
        require you to make changes to your policies before your demo.
      </p>
      <p>
        Our requirements for privacy policies and terms of service are listed below. We strongly
        suggest you review your policies to make sure they meet these requirements before you upload
        them.
      </p>
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ul className="vads-u-margin-bottom--0">
                ...
                <li>
                  Clearly indicate if data is used for transactions that do not, but could, involve
                  money, such as targeted advertising.
                </li>
                <li>
                ...
                <li>
                  Indicate that third parties are bound to the terms and conditions in your privacy
                  policy.
                </li>
                <li>
                ...
                <li>
                  ...
                  policy that the new company’s policies will align with yours, or provide the user
                ...
                <li>
                  Clearly state how you will get active consent for policy changes and provide users
                  with plain-language summaries of what has changed.
                </li>
              </ul>
            </td>
          </tr>
