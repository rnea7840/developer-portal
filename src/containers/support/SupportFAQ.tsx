...
import GroupedAccordions, { PanelContent } from '../../components/GroupedAccordions';
...
const generalQuestions: ISupportQuestion[] = [
  ...
  },
  {
    answer: (
      <p>
        The APIs are the "front door" or "wall outlet" to VA health records, benefits eligibility,
        facility locations, and veteran status verification. Developers may create applications to
        securely access this information via mobile devices and web browsers, across a variety of
        platforms.',
      </p>
    ),
    ...
    answer: (
      <React.Fragment>
        <p>
          ...
          with the subject line "Request for Sandbox Access to Address Validation API." In the
          email, include the following:
        </p>
        <ul>
          ...
          <li>
            When indicating your desired production date, note that we require at least one week's
            notice before a demo can be scheduled, and that it may take up to a week after the demo
            to grant you the sandbox key for the Address Validation API.
          </li>
        </ul>
