...
const generalQuestions: ISupportQuestion[] = [
  {
    answer: (
      ...
      <p>
        If you are a Veteran trying to access VA records in the iPhone Health app, please visit <a href="https://support.apple.com/en-us/HT208680">View health records on your iPhone</a>.
      </p>
      </>
    ),
